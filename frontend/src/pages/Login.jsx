    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">Sign in to BridgeDesk workspace</p>
        </div>
        ...
        <div className="card-container border-t-4 border-t-indigo-500">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-700/80 rounded-xl pl-11 pr-4 py-3.5 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all"
                  placeholder="admin@bridgedesk.com"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition duration-200 font-medium shadow-lg shadow-indigo-900/30 flex items-center justify-center transform active:scale-95 disabled:opacity-70 mt-4"
            >
              {isLoading ? (
